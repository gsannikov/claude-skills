...
create_dir "$SKILL_ROOT/docs/guides"
create_dir "$SKILL_ROOT/docs/guides/user-guide"
create_dir "$SKILL_ROOT/docs/guides/developer-guide"
create_dir "$SKILL_ROOT/docs/project"
create_dir "$SKILL_ROOT/docs/project/features"

# Automation directories
create_dir "$SKILL_ROOT/host_scripts"
create_dir "$SKILL_ROOT/.github"
create_dir "$SKILL_ROOT/.github/workflows"
...
echo "  - docs/guides/user-guide/ for usage instructions"
echo "  - docs/guides/developer-guide/ for development guide"
echo ""
echo "Validation:"
echo "  Run: python3 host_scripts/validate.py"
echo ""
