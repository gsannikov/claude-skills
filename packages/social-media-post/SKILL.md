...
description: Generate optimized social media posts for Threads, X (Twitter), and LinkedIn. Analyzes platform algorithms, applies best practices, and creates engaging content tailored to each platform.
---
...
**User Data Location**: `~/MyDrive/claude-skills-data/social-media-post/`

```
social-media-post/
├── posts/                    # Generated posts archive
│   └── {date}-{platform}.md
├── templates/                # Custom user templates
├── analytics/                # Engagement tracking (optional)
│   └── metrics.yaml
